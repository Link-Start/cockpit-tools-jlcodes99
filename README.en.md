...
A **universal AI IDE account management tool**, currently supporting **Antigravity**, **Codex**, **Cursor**, **GitHub Copilot**, **Windsurf**, and **Kiro**, with multi-instance parallel workflows.
...
**Features**: One-click Switch · Multi-account Management · Multi-instance · Quota Monitoring · Wake-up Tasks · Device Fingerprints · Plugin Integration · Cursor Management · GitHub Copilot Management · Windsurf Management · Kiro Management
...
- **Six-Platform Support**: Simultaneously displays Antigravity, Codex, Cursor, GitHub Copilot, Windsurf, and Kiro account status
...
- **Account Import**: OAuth, Token/JSON import, and local import
- **Quota View**: Shows Plan, Prompt credits, Add-on prompt credits, and cycle information
- **Batch Operations**: Tags and bulk actions
...
- **Data is mainly stored on your machine**:
  ...
  - local app data folder under `com.antigravity.cockpit-tools`: Codex / Cursor / GitHub Copilot / Windsurf / Kiro multi-account index data, etc.
...
| Antigravity/Codex/Cursor/VS Code/Windsurf/Kiro/OpenCode App Path | Manually set executable path | Leave empty (auto-detect) | Change only if auto-detect fails or you use custom install paths |
